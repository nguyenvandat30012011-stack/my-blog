...
export default function ResourceDropdown() {
  ...
  // Tự động đóng menu tài nguyên nếu người dùng click ra ngoài khu vực menu
  useEffect(() => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      {/* Nút bấm kích hoạt menu tài nguyên */}
      <button 
      ...
      {/* ĐOẠN CODE THỨ 2 CỦA BẠN ĐƯỢC TÍCH HỢP Ở ĐÂY VỚI LOGIC ẨN / HIỆN */}
      {isOpen && (
