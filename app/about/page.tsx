          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                ...
                >
                  <svg className="h-4 w-4 text-blue-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round5" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
                  Liên hệ qua Email
                </Link>
              </div>
            </div>
